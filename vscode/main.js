...
let privacy=document.getElementsByClassName('privacy-wrap');
...
btnClassify.forEach(btn=>{
    ...
    renderClassifyProduct(filterData);
    console.log(type);
})
})

function renderClassifyProduct(filterData)
{
